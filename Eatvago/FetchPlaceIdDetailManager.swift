...
class FetchPlaceIdDetailManager {
    ...
    func requestPlaceIdDetail(locationsWithoutDetail: [Location], myLocation: CLLocation) {
        ...
        for location in locationsWithoutDetail {
            ...
            Alamofire.request(urlString).responseJSON { (response) in
                ...
                let urlStringForDistance = "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=\(myLocation.coordinate.latitude),\(myLocation.coordinate.longitude)&destinations=\(location.latitude),\(location.longitude)&key=\(googleMapDistanceMatrixAPIKey)"
                ...
                Alamofire.request(urlStringForDistance).responseJSON { (response) in
                    ...
                    locationWithDetail.distanceText = distanceText
                    locationWithDetail.durationText = durationText
